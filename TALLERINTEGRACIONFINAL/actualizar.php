...
<div class="row">
	...
	<div class="span12">
		...
		<form action="ejecutaactualizar.php" method="post">
				...
				Rut<br> <input type="text" name="email" value="<?php echo $email?>"><br>
				Correo<br> <input type="text" name="rut" value="<?php echo $rut?>"><br>
				<br>
...
</div><script src="style/js/jquery-1.8.3.min.js"></script>
